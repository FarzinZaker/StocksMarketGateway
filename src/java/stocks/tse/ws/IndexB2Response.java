...
public class IndexB2Response  implements java.io.Serializable {
    private stocks.tse.ws.IndexB2ResponseIndexB2Result indexB2Result;

    public IndexB2Response() {
    }

    public IndexB2Response(
           stocks.tse.ws.IndexB2ResponseIndexB2Result indexB2Result) {
     ...
     */
    public stocks.tse.ws.IndexB2ResponseIndexB2Result getIndexB2Result() {
        return indexB2Result;
    }
     ...
     * @param indexB2Result
     */
    public void setIndexB2Result(stocks.tse.ws.IndexB2ResponseIndexB2Result indexB2Result) {
        this.indexB2Result = indexB2Result;
    }
