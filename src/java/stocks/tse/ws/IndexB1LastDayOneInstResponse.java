...
public class IndexB1LastDayOneInstResponse  implements java.io.Serializable {
    private stocks.tse.ws.IndexB1LastDayOneInstResponseIndexB1LastDayOneInstResult indexB1LastDayOneInstResult;

    public IndexB1LastDayOneInstResponse() {
    }

    public IndexB1LastDayOneInstResponse(
           stocks.tse.ws.IndexB1LastDayOneInstResponseIndexB1LastDayOneInstResult indexB1LastDayOneInstResult) {
     ...
     */
    public stocks.tse.ws.IndexB1LastDayOneInstResponseIndexB1LastDayOneInstResult getIndexB1LastDayOneInstResult() {
        return indexB1LastDayOneInstResult;
    }
     ...
     */
    public void setIndexB1LastDayOneInstResult(stocks.tse.ws.IndexB1LastDayOneInstResponseIndexB1LastDayOneInstResult indexB1LastDayOneInstResult) {
        this.indexB1LastDayOneInstResult = indexB1LastDayOneInstResult;
    }
