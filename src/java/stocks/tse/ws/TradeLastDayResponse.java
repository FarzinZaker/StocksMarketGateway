...
public class TradeLastDayResponse  implements java.io.Serializable {
    private stocks.tse.ws.TradeLastDayResponseTradeLastDayResult tradeLastDayResult;

    public TradeLastDayResponse() {
    }

    public TradeLastDayResponse(
           stocks.tse.ws.TradeLastDayResponseTradeLastDayResult tradeLastDayResult) {
     ...
     */
    public stocks.tse.ws.TradeLastDayResponseTradeLastDayResult getTradeLastDayResult() {
        return tradeLastDayResult;
    }
     ...
     */
    public void setTradeLastDayResult(stocks.tse.ws.TradeLastDayResponseTradeLastDayResult tradeLastDayResult) {
        this.tradeLastDayResult = tradeLastDayResult;
    }
