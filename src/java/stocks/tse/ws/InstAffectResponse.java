...
public class InstAffectResponse  implements java.io.Serializable {
    private stocks.tse.ws.InstAffectResponseInstAffectResult instAffectResult;

    public InstAffectResponse() {
    }

    public InstAffectResponse(
           stocks.tse.ws.InstAffectResponseInstAffectResult instAffectResult) {
     ...
     */
    public stocks.tse.ws.InstAffectResponseInstAffectResult getInstAffectResult() {
        return instAffectResult;
    }
     ...
     */
    public void setInstAffectResult(stocks.tse.ws.InstAffectResponseInstAffectResult instAffectResult) {
        this.instAffectResult = instAffectResult;
    }
