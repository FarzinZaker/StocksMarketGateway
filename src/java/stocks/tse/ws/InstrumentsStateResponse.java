...
public class InstrumentsStateResponse  implements java.io.Serializable {
    private stocks.tse.ws.InstrumentsStateResponseInstrumentsStateResult instrumentsStateResult;

    public InstrumentsStateResponse() {
    }

    public InstrumentsStateResponse(
           stocks.tse.ws.InstrumentsStateResponseInstrumentsStateResult instrumentsStateResult) {
     ...
     */
    public stocks.tse.ws.InstrumentsStateResponseInstrumentsStateResult getInstrumentsStateResult() {
        return instrumentsStateResult;
    }
     ...
     */
    public void setInstrumentsStateResult(stocks.tse.ws.InstrumentsStateResponseInstrumentsStateResult instrumentsStateResult) {
        this.instrumentsStateResult = instrumentsStateResult;
    }
