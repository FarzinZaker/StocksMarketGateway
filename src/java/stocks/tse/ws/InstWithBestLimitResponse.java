...
public class InstWithBestLimitResponse  implements java.io.Serializable {
    private stocks.tse.ws.InstWithBestLimitResponseInstWithBestLimitResult instWithBestLimitResult;

    public InstWithBestLimitResponse() {
    }

    public InstWithBestLimitResponse(
           stocks.tse.ws.InstWithBestLimitResponseInstWithBestLimitResult instWithBestLimitResult) {
     ...
     */
    public stocks.tse.ws.InstWithBestLimitResponseInstWithBestLimitResult getInstWithBestLimitResult() {
        return instWithBestLimitResult;
    }
     ...
     */
    public void setInstWithBestLimitResult(stocks.tse.ws.InstWithBestLimitResponseInstWithBestLimitResult instWithBestLimitResult) {
        this.instWithBestLimitResult = instWithBestLimitResult;
    }
