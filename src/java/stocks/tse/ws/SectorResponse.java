...
public class SectorResponse  implements java.io.Serializable {
    private stocks.tse.ws.SectorResponseSectorResult sectorResult;

    public SectorResponse() {
    }

    public SectorResponse(
           stocks.tse.ws.SectorResponseSectorResult sectorResult) {
     ...
     * @return sectorResult
     */
    public stocks.tse.ws.SectorResponseSectorResult getSectorResult() {
        return sectorResult;
    }
     ...
     * @param sectorResult
     */
    public void setSectorResult(stocks.tse.ws.SectorResponseSectorResult sectorResult) {
        this.sectorResult = sectorResult;
    }
