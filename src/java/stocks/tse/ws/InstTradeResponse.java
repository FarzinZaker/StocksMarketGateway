...
public class InstTradeResponse  implements java.io.Serializable {
    private stocks.tse.ws.InstTradeResponseInstTradeResult instTradeResult;

    public InstTradeResponse() {
    }

    public InstTradeResponse(
           stocks.tse.ws.InstTradeResponseInstTradeResult instTradeResult) {
     ...
     */
    public stocks.tse.ws.InstTradeResponseInstTradeResult getInstTradeResult() {
        return instTradeResult;
    }
     ...
     */
    public void setInstTradeResult(stocks.tse.ws.InstTradeResponseInstTradeResult instTradeResult) {
        this.instTradeResult = instTradeResult;
    }
