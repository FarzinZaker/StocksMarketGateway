...
public class SubSectorResponse  implements java.io.Serializable {
    private SubSectorResponseSubSectorResult subSectorResult;

    public SubSectorResponse() {
    }

    public SubSectorResponse(
           SubSectorResponseSubSectorResult subSectorResult) {
     ...
     */
    public SubSectorResponseSubSectorResult getSubSectorResult() {
        return subSectorResult;
    }
     ...
     */
    public void setSubSectorResult(SubSectorResponseSubSectorResult subSectorResult) {
        this.subSectorResult = subSectorResult;
    }
