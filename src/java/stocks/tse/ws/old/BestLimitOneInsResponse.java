...
public class BestLimitOneInsResponse  implements java.io.Serializable {
    private BestLimitOneInsResponseBestLimitOneInsResult bestLimitOneInsResult;

    public BestLimitOneInsResponse() {
    }

    public BestLimitOneInsResponse(
           BestLimitOneInsResponseBestLimitOneInsResult bestLimitOneInsResult) {
     ...
     */
    public BestLimitOneInsResponseBestLimitOneInsResult getBestLimitOneInsResult() {
        return bestLimitOneInsResult;
    }
     ...
     */
    public void setBestLimitOneInsResult(BestLimitOneInsResponseBestLimitOneInsResult bestLimitOneInsResult) {
        this.bestLimitOneInsResult = bestLimitOneInsResult;
    }
