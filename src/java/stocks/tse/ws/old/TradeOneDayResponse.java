...
public class TradeOneDayResponse  implements java.io.Serializable {
    private TradeOneDayResponseTradeOneDayResult tradeOneDayResult;

    public TradeOneDayResponse() {
    }

    public TradeOneDayResponse(
           TradeOneDayResponseTradeOneDayResult tradeOneDayResult) {
     ...
     */
    public TradeOneDayResponseTradeOneDayResult getTradeOneDayResult() {
        return tradeOneDayResult;
    }
     ...
     */
    public void setTradeOneDayResult(TradeOneDayResponseTradeOneDayResult tradeOneDayResult) {
        this.tradeOneDayResult = tradeOneDayResult;
    }
