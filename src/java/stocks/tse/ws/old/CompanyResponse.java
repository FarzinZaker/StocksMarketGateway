...
public class CompanyResponse  implements java.io.Serializable {
    private CompanyResponseCompanyResult companyResult;

    public CompanyResponse() {
    }

    public CompanyResponse(
           CompanyResponseCompanyResult companyResult) {
     ...
     */
    public CompanyResponseCompanyResult getCompanyResult() {
        return companyResult;
    }
     ...
     * @param companyResult
     */
    public void setCompanyResult(CompanyResponseCompanyResult companyResult) {
        this.companyResult = companyResult;
    }
