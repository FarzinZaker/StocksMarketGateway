...
public class ShareChangeResponse  implements java.io.Serializable {
    private ShareChangeResponseShareChangeResult shareChangeResult;

    public ShareChangeResponse() {
    }

    public ShareChangeResponse(
           ShareChangeResponseShareChangeResult shareChangeResult) {
     ...
     */
    public ShareChangeResponseShareChangeResult getShareChangeResult() {
        return shareChangeResult;
    }
     ...
     */
    public void setShareChangeResult(ShareChangeResponseShareChangeResult shareChangeResult) {
        this.shareChangeResult = shareChangeResult;
    }
