...
public class SectorStateResponse  implements java.io.Serializable {
    private SectorStateResponseSectorStateResult sectorStateResult;

    public SectorStateResponse() {
    }

    public SectorStateResponse(
           SectorStateResponseSectorStateResult sectorStateResult) {
     ...
     */
    public SectorStateResponseSectorStateResult getSectorStateResult() {
        return sectorStateResult;
    }
     ...
     */
    public void setSectorStateResult(SectorStateResponseSectorStateResult sectorStateResult) {
        this.sectorStateResult = sectorStateResult;
    }
