...
public class MarketActivityDailyResponse  implements java.io.Serializable {
    private MarketActivityDailyResponseMarketActivityDailyResult marketActivityDailyResult;

    public MarketActivityDailyResponse() {
    }

    public MarketActivityDailyResponse(
           MarketActivityDailyResponseMarketActivityDailyResult marketActivityDailyResult) {
     ...
     */
    public MarketActivityDailyResponseMarketActivityDailyResult getMarketActivityDailyResult() {
        return marketActivityDailyResult;
    }
     ...
     */
    public void setMarketActivityDailyResult(MarketActivityDailyResponseMarketActivityDailyResult marketActivityDailyResult) {
        this.marketActivityDailyResult = marketActivityDailyResult;
    }
