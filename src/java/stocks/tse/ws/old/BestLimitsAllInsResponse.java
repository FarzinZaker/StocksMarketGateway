...
public class BestLimitsAllInsResponse  implements java.io.Serializable {
    private BestLimitsAllInsResponseBestLimitsAllInsResult bestLimitsAllInsResult;

    public BestLimitsAllInsResponse() {
    }

    public BestLimitsAllInsResponse(
           BestLimitsAllInsResponseBestLimitsAllInsResult bestLimitsAllInsResult) {
     ...
     */
    public BestLimitsAllInsResponseBestLimitsAllInsResult getBestLimitsAllInsResult() {
        return bestLimitsAllInsResult;
    }
     ...
     */
    public void setBestLimitsAllInsResult(BestLimitsAllInsResponseBestLimitsAllInsResult bestLimitsAllInsResult) {
        this.bestLimitsAllInsResult = bestLimitsAllInsResult;
    }
