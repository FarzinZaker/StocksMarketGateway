...
public class IndexInstrumentResponse  implements java.io.Serializable {
    private IndexInstrumentResponseIndexInstrumentResult indexInstrumentResult;

    public IndexInstrumentResponse() {
    }

    public IndexInstrumentResponse(
           IndexInstrumentResponseIndexInstrumentResult indexInstrumentResult) {
     ...
     */
    public IndexInstrumentResponseIndexInstrumentResult getIndexInstrumentResult() {
        return indexInstrumentResult;
    }
     ...
     */
    public void setIndexInstrumentResult(IndexInstrumentResponseIndexInstrumentResult indexInstrumentResult) {
        this.indexInstrumentResult = indexInstrumentResult;
    }
