...
public class FutureInformationResponse  implements java.io.Serializable {
    private FutureInformationResponseFutureInformationResult futureInformationResult;

    public FutureInformationResponse() {
    }

    public FutureInformationResponse(
           FutureInformationResponseFutureInformationResult futureInformationResult) {
     ...
     */
    public FutureInformationResponseFutureInformationResult getFutureInformationResult() {
        return futureInformationResult;
    }
     ...
     */
    public void setFutureInformationResult(FutureInformationResponseFutureInformationResult futureInformationResult) {
        this.futureInformationResult = futureInformationResult;
    }
