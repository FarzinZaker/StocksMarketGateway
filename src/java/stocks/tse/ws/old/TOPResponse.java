...
public class TOPResponse  implements java.io.Serializable {
    private TOPResponseTOPResult TOPResult;

    public TOPResponse() {
    }

    public TOPResponse(
           TOPResponseTOPResult TOPResult) {
     ...
     * @return TOPResult
     */
    public TOPResponseTOPResult getTOPResult() {
        return TOPResult;
    }
     ...
     * @param TOPResult
     */
    public void setTOPResult(TOPResponseTOPResult TOPResult) {
        this.TOPResult = TOPResult;
    }
