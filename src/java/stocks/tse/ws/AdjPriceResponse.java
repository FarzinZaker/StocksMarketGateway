...
public class AdjPriceResponse  implements java.io.Serializable {
    private stocks.tse.ws.AdjPriceResponseAdjPriceResult adjPriceResult;

    public AdjPriceResponse() {
    }

    public AdjPriceResponse(
           stocks.tse.ws.AdjPriceResponseAdjPriceResult adjPriceResult) {
     ...
     */
    public stocks.tse.ws.AdjPriceResponseAdjPriceResult getAdjPriceResult() {
        return adjPriceResult;
    }
     ...
     */
    public void setAdjPriceResult(stocks.tse.ws.AdjPriceResponseAdjPriceResult adjPriceResult) {
        this.adjPriceResult = adjPriceResult;
    }
