...
public class PaymentIFBindingLocator extends org.apache.axis.client.Service implements stocks.payment.saman.PaymentIFBinding {
    ...
    public stocks.payment.saman.PaymentIFBindingSoap_PortType getPaymentIFBindingSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            stocks.payment.saman.PaymentIFBindingSoapStub _stub = new stocks.payment.saman.PaymentIFBindingSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (stocks.payment.saman.PaymentIFBindingSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                stocks.payment.saman.PaymentIFBindingSoapStub _stub = new stocks.payment.saman.PaymentIFBindingSoapStub(new java.net.URL(PaymentIFBindingSoap_address), this);
                _stub.setPortName(getPaymentIFBindingSoapWSDDServiceName());
                return _stub;
            }
        }
