			...
			if (!moxman.ui) {
				ResourceLoader.load({
					js: [
						...
						Env.baseUrl + "/api.php?act=language" + (settings.language ? '&code=' + settings.language : ''),
						Env.baseUrl + "/api.php?act=PluginJs"
					],
...
define("moxman/interop/TinyMcePlugin", [
	...
	if (langCode && langCode != 'en') {
		tinymce.ScriptLoader.load((tinymce.PluginManager.urls.moxiemanager || tinymce.baseURL + '/plugins/moxiemanager') + '/api.php?act=language&tinymce=true&code=' + langCode);
	}
});
