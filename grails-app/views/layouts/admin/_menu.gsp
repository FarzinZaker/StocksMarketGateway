<ul id="menu">
    <li>
        ...
        <ul>
            <li><a href="${createLink(controller: 'province', action: 'build')}"><g:message
                    code="menu.basicInfo.province.add"/></a></li>
            <li><a href="${createLink(controller: 'province', action: 'list')}"><g:message
    ...
    <li>
        ...
        <ul>
            <li><a href="${createLink(controller: 'broker', action: 'build')}"><g:message code="menu.broker.add"/></a>
            </li>
            <li><a href="${createLink(controller: 'broker', action: 'list')}"><g:message code="menu.broker.list"/></a>
            </li>
        </ul>
    </li>
    <li>
