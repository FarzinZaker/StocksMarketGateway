    ...
    <div class="col-sm-3">
        <div class="groupDashboardButton n1">
            ...
            <div>
                ...
                <a href="${createLink(controller: 'user', action: 'wall', id: item.identifier)}">${item.title} <span class="counter">(<g:formatNumber number="${item.count}" type="number"/>)</span></a>

                <p onclick="showTopList('${createLink(controller: 'dashboard', action: 'mostActivePersons')}','${message(code:'mostActivePersons.title')}')"><g:message code="tops.more"/></p>
            </div>
        </div>
    </div>
    ...
    <div class="col-sm-3">
        <div class="groupDashboardButton n3">
            ...
            <div>
                ...
                <a href="${createLink(controller: 'twitter', action: 'property', id: item.identifier)}">${item.title} <span class="counter">(<g:formatNumber number="${item.count}" type="number"/>)</span></a>

                <p onclick="showTopList('${createLink(controller: 'dashboard', action: 'mostActiveProperties')}','${message(code:'mostActiveProperty.title')}')"><g:message code="tops.more"/></p>
            </div>
        </div>
    </div>
    ...
    <div class="col-sm-3">
        <div class="groupDashboardButton n4">
            ...
            <div>
                ...
                <a href="${createLink(controller: 'group', action: 'home', id: item.idNumber)}">${item.title} <span class="counter">(<g:formatNumber number="${item.size}" type="number"/>)</span></a>

                <p onclick="showTopList('${createLink(controller: 'dashboard', action: 'largestGroups')}','${message(code:'largestGroup.title')}')"><g:message code="tops.more"/></p>
            </div>
        </div>
    </div>
</div>
