...
<script type="text/javascript">
    ...
    function loadMoreMaterials() {
        if (!materialListStillLoading) {
            ...
            $.ajax({
                type: "POST",
                url: '${createLink(action: 'propertyJson', id:property.idNumber)}',
    ...
    $(document).ready(function () {
        ...
        %{--'contentPage': '${createLink(action: 'homeJson', id:property.idNumber)}', // the url you are fetching the results--}%
