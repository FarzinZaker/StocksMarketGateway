<div class="dashLet hideBeforeLoad noPlaceReservation">
    <h2 style="float:right"><i class="fa fa-line-chart"></i> <g:message code="topGroups.title"/></h2>

    <div id="marketViewTimer"></div>

    <div class="k-rtl clear-fix">
        <div id="tabstripGroup">
            <ul>
                <li class="k-state-active">
                    <g:message code="topGroups.mostFollowers"/>
                    %{--</li>--}%
                <li>
                    <g:message code="topGroups.mostPosts"/>
                </li>
                <li>
                    <g:message code="topGroups.topUserRank"/>
                </li>
                <li>
                    <g:message code="topGroups.top4tabloRank"/>
                </li>
            </ul>
...
//            }
    ...
    $(document).ready(function () {
        $("#tabstripGroup").kendoTabStrip({
            ...
            contentUrls:[
                '<g:createLink controller="user" action="mostCards" id="mostFollowedGroups" />',
                '<g:createLink controller="user" action="mostCards" id="mostActiveGroups" />',
                '<g:createLink controller="user" action="mostCards" id="mostRatedGroups" />',
                '<g:createLink controller="user" action="mostCards" id="mostRated4tabloGroups" />'
            ]
        });
