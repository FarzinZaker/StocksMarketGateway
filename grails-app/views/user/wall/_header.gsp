<div>
    ...
    <ul class="twitterAuthorInfo">
        ...
        <li style="border-bottom-color:#8ebc00;margin-right:30px;">
        ...
        %{--</li>--}%
        <li style="border-bottom-color:#60a917;margin-right:30px;">
        ...
        <li style="border-bottom-color:#d80073;margin-right:30px;">
