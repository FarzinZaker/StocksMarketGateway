...
<p align="center" class="footer" style="direction: rtl;font-family: Tahoma,Arial,serif;font-size: 11px;margin-bottom: 5px;margin-top: 30px;color:grey;">
    ...
    <a href="http://www.4tablo.ir">4تابلو</a>
    نیستید روی لینک
    <a href="http://www.4tablo.ir/subscription/remove?email=${URLEncoder.encode(email)}&source=${source}&token=${AuthenticationProvider.md5("unsubscribe ${email} from ${source} of 4tablo")}">درخواست عدم دریافت نامه</a>
    کلیک کنید.
</p>
...
<p align="center" class="footer" style="font-size: 11px;font-family: times, Arial,serif;margin-top:0;color:grey;">
    ...
    <a href="http://www.4tablo.ir/subscription/remove?email=${URLEncoder.encode(email)}&source=${source}&token=${AuthenticationProvider.md5("unsubscribe ${email} from ${source} of 4tablo")}">unsubscribe</a>
</p>
</body>
</html>