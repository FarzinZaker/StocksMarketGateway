    ...
    Boolean check(Symbol symbol, String parameter, String operator, Object value, Date date) {
        ...
        switch (operator) {
            case Operators.UPPER_THAN:
                return indicatorCompareService.indicatorUpperThanValue(symbol, ATR, parameter, targetValue, date)
            case Operators.LOWER_THAN:
                return indicatorCompareService.indicatorLowerThanValue(symbol, ATR, parameter, targetValue, date)
