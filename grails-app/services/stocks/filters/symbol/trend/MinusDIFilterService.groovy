    ...
    Boolean check(Symbol symbol, String parameter, String operator, Object value, Date date, String adjustmentType) {
        ...
        switch (operator) {
            case Operators.UPPER_THAN:
                return indicatorCompareService.indicatorUpperThanValue(symbol, MinusDI, parameter, targetValue, date, adjustmentType)
            case Operators.LOWER_THAN:
                return indicatorCompareService.indicatorLowerThanValue(symbol, MinusDI, parameter, targetValue, date, adjustmentType)
            case Operators.CROSSING_TO_UP:
                return indicatorCompareService.indicatorCrossUpValue(symbol, MinusDI, parameter, targetValue, date, adjustmentType)
            case Operators.CROSSING_TO_DOWN:
                return indicatorCompareService.indicatorCrossDownValue(symbol, MinusDI, parameter, targetValue, date, adjustmentType)
        }
        false
    }
