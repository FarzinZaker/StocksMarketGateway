...
searchable {
     ...
     */
    compassSettings = [
            'compass.engine.analyzer.default.filters': 'farsi',
            'compass.engine.analyzer.search.filters': 'farsi',
            'compass.engine.analyzerfilter.farsi.type': 'stocks.search.FarsiNormalizationFilterProvider'
    ]
