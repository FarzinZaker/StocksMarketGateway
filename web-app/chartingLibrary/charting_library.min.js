    ...
    if (!window.TradingView) {
        var f = {
            ...
            gEl: function (a) {
                ...
                var b = document.getElementsByTagName("head")[0], e = document.createElement("style");
                e.type = "text/css";
        ...
        d.widget.prototype = {
            ...
            _autoResizeChart: function () {
                var a = d.gEl(this.id);
                this.options.fullscreen && (a.style.height = (window.innerHeight - 240) + "px", a.style.width = "100%")
            }, create: function () {
                var a = this.render(), b = this, e;
                ...
                this.postMessage.post(this._messageTarget(), "changeSymbol", {symbol: a, interval: b});
                this.postMessage.on("symbolChangeFinished", e)
            }, createStudy: function (a, b, e) {
                this.postMessage.post(this._messageTarget(), "createStudy", {name: a, lock: b, forceOverlay: e})
            }, createShape: function (a, b) {
                this.postMessage.post(this._messageTarget(),
                    "createShape", {point: a, options: b})
            }, createVerticalLine: function (a, b) {
                this.createShape(a, $.extend(b, {shape: "vertical_line"}))
            }, _lastBarPoint: function () {
                var a = d.gEl(this.id).contentWindow.Z2, b = a.model().timeScale().m_points.lastTimePointIndex(), a = a.model().mainSeries().data().valueAt(b)[4];
                return {index: b, price: a}
            }, createOrderLine: function () {
                var a = d.gEl(this.id).contentWindow.Z2, b = a._paneWidgets[0]._state;
            ...
            createPositionLine: function () {
                ...
                var a = d.gEl(this.id).contentWindow.headerWidget, a = a.createGroup({single: !0}).appendTo(a._$left);
            ...
            onAutoSaveNeeded: function (a) {
                ...
                window.__TVSavedChart = {json: a, extendedData: b};
            ...
            window.addEventListener && window.addEventListener("message", function (e) {
                ...
                c.provider && "TradingView" == c.provider && ("get" == c.type ? b[c.name].call(c, c.data, function (a) {
                    d.postMessage(JSON.stringify({
                        id: c.id,
                        type: "on", name: c.name, client_id: c.client_id, data: a, provider: "TradingView"
                    }), "*")
            ...
            return function (h, c) {
                ...
                return {
                    on: function (a, c) {
                        ...
                        b = {id: g++, type: "get", name: b, client_id: c, data: d, provider: "TradingView"};
                        a[c][b.id] = f;
                        e[c].postMessage(JSON.stringify(b), "*")
                    },
                    post: function (a, b, c) {
                        b = {id: f++, type: "post", name: b, data: c, provider: "TradingView"};
